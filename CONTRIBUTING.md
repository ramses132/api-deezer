...
Contributions to api-deezer are very welcome! Best have a look at the open [issues](https://github.com/ramses132/api-deezer)
and open a [GitHub pull request](https://github.com/ramses132/api-deezer/compare). See instructions below how to setup development
...
To work on api-deezer you first need to clone

```bash
git clone https://github.com/ramses132/api-deezer.git
cd api-deezer
```
...
echo UID=$UID > .env
# open shell
docker-compose run --rm api-deezer bash
```
