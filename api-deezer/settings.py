...
INSTALLED_APPS = [
    ...
    'django_filters',
    'drf_yasg',
    "api-deezer.api_deezer.apps.DefaultConfig",
]
...
ROOT_URLCONF = "api-deezer.urls"
WSGI_APPLICATION = "api-deezer.wsgi.application"
...
DATABASES = {
    ...
    #     ),
    #     "NAME": env.str("DATABASE_NAME", default="api-deezer"),
    #     "USER": env.str("DATABASE_USER", default="api-deezer"),
    #     "PASSWORD": env.str(
    #         "DATABASE_PASSWORD", default=default("api-deezer")
    #     ),
...
AUTH_USER_MODEL = "api_deezer.User"
